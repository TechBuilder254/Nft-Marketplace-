    ...
    return (
        ...
        <div className= {styles.card}>
            ...
            <div className= {styles.container02}>
                ...
                <p>Hey, I&#39;m Alexander, and I&#39;m excited to welcome you to my NFT marketplace! I&#39;ve worked hard to create a platform that not only makes it easy to buy and sell NFTs but also brings a fresh, interactive experience for all users. What sets my marketplace apart is the engaging UI that keeps you updated with real-time messages for every transaction. Want to show love to an NFT? Use our like feature and let others know your favorites!</p>
                <br></br>
                <p>
